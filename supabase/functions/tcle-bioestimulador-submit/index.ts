...
const TERM_SHA256 =
  "cf2c0958cc679441b99849ded246d12ee1b9f7aaa102604a441dda1720a66213";
const RELEASED = true;
...
async function buildCanonicalPdf(
  ...
  pdf.setTitle(
    "TCLE - Bioestimulador de Colágeno - " + data.identificacao.nome,
  );
  pdf.setSubject(
  ...
  textBlock("BIOESTIMULADOR DE COLÁGENO", {
    font: bold,
    size: 11,
    lineHeight: 15,
    after: 4,
  ...
  textBlock(
    "A definição final do produto, composição, quantidade, técnica, pontos e regiões depende de avaliação profissional e da documentação aplicável ao produto proposto.",
    { font: bold },
  );
  ...
  textBlock(
    "[CONFIRMADO] Compreendeu que os riscos variam conforme produto, composição, técnica e região e devem ser explicados antes do procedimento.",
  );
  textBlock(
  ...
  textBlock(
    "Princípio ativo/composição: _______________________________________________________",
    { after: 13 },
  );
  textBlock(
    "Fabricante/fornecedor, quando aplicável: __________________________________________",
    { after: 13 },
  );
  textBlock(
  ...
  textBlock(
    "Quantidade/volume e unidade: ______________________________________________________",
    { after: 13 },
  );
  textBlock(
    "Concentração/diluição/reconstituição, quando aplicável: ___________________________",
    { after: 13 },
  );
  textBlock(
    "Região, técnica e dispositivo: ____________________________________________________",
    { after: 13 },
  );
  textBlock(
    "Indicação e instrução de uso conferidas em: ______________________________________",
    { after: 13 },
  );
  textBlock(
    "Benefícios, limitações, riscos, interações e alternativas específicos explicados:",
    { after: 8 },
  );
  textBlock(
  ...
  textBlock(
    "Dúvidas esclarecidas e orientação individual: ____________________________________",
    { after: 13 },
  );
  textBlock(
    "________________________________________________________________________________",
  ...
  textBlock(
    "Orientações e registro do material entregues ao paciente:  [  ] Sim  [  ] Não",
    { after: 18 },
  );
...
Deno.serve(async (req: Request) => {
  ...
  if (!RELEASED) {
    return fail(
      ...
      "Este documento ainda não está liberado para receber envios.",
      423,
    );
  }
  if (
  ...
  try {
    ...
    if (previous?.status === "recebido") {
      ...
      return json(req, {
        ...
        pdf_nome: "Pre-Avaliacao-Bioestimulador-Colageno-" +
  ...
  const signaturePath = "tcle-bioestimulador/" + idempotencyKey +
    "/assinatura.png";
  const pdfPath = "tcle-bioestimulador/" + idempotencyKey + "/documento.pdf";
